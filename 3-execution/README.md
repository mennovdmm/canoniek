...
- [3.2 — Processes](3.2-processes/) — the process format + the skill-vs-process test + a golden example.
- [3.3 — Templates](3.3-templates/) — skill / rulebook / state / registry templates.
- [3.4 — Bootstrap](3.4-bootstrap/) — the interview that generates your first core.
